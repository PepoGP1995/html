<?php
	...
	define( "DIR_RAIZ", $_SERVER['DOCUMENT_ROOT']."/formulariophp7/Highcharts-9.3.2/examples/line-basic" );
	define( "DIR_INC", DIR_RAIZ . "/includes/" );
	
	define( "HOST", "http://" . $_SERVER['HTTP_HOST'] );
	define( "DIR_IMG", HOST . "/formulariophp7/Highcharts-9.3.2/examples/line-basic/images/" );
