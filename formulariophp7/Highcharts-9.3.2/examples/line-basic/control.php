...
<body>
    <br>
<button onclick="location.href='lineal.php'" value="New Tab" target="_blank">Grafica Lineal</button>
<br>
<button onclick="location.href='gauge.php'" value="New Tab" target="_blank">Grafica Gauge</button>
</body>
</html>
