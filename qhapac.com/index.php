<!DOCTYPE html>
<html lang="es">
<?php require_once('/chatbot/onfig.php'); ?>
 <?php require_once('/chatbot/inc/header.php') ?>
<head>

     <title>Qhapac Tech</title>
<!--
...
<div class="wrapper">
        <?php require_once('/chatbot/inc/topBarNav.php') ?>

        <?php $page = isset($_GET['page']) ? $_GET['page'] : '/chatbot/portal';  ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up">Soluciones Tecnológicas e Informáticas</h1>

                                   <a href="contact.html" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Chat with us!</a>
                          <!-- HERO   <strong class="d-block py-3 pl-5 text-white" data-aos="fade-up" data-aos-delay="200"><i class="fa fa-phone mr-2"></i> +99 080 070 4224</strong> -->
                        ...
                        <h2 class="mb-5 text-center" data-aos="fade-up">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   <img src="images/project/monitoreo2.PNG" class="img-fluid" alt="project image">
